...
int loadModel(double* modelPoints, double* imagePoints, char* fname)
{
   int n=0;
   FILE* fpi = fopen(fname,"rt");
...
int main(int argc, char** argv)
{
	...
	n = loadModel(modelPoints, imagePoints, argv[1]);
	...
	*/
	tsai3D_define_camera_parameters(GP2,0,0,0,0,0,0,0,&CameraParameters);
